...
class clsBankOprations
{
public:
	static void read_clint_data(clsBankClient& clint)
	{
		cout << "first name : ";
	...
	static void saving_chick(clsBankClient::ensavemode save)
	{
		switch (save)
		{
	...
	static string read_new_account_num()
	{
	...
	static string read_account_num()
	{
		string account_num;
