...
#include"clsTransferLogScrean.h"
using namespace std;
...
private:
	enum enchoise
	{
		dipoist = 1, withdraw, T_balance, transfer, transferlog, mainmenue
	};
	...
	static void _transfer_log()
	{
		clsTransferLogScrean::show_transfer_log_screan();
	}
